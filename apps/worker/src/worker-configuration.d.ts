/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings apps/worker/src/worker-configuration.d.ts` (hash: 94ac76aa4273f7c7ac499ab8d2b2bb13)
...
interface __BaseEnv_CloudflareBindings {
	...
	EVENT_COORDINATOR: DurableObjectNamespace<import("./index").EventCoordinator>;
	PLANNING_HISTORY_COMPACTION: Workflow<Parameters<import("./index").PlanningHistoryCompactionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "EventCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATA_JURISDICTION" | "PUSH_RETENTION_DAYS" | "SOURCE_REVISION" | "ANALYSIS_RETENTION_DAYS" | "PLANNING_DETAIL_RETENTION_HOURS" | "PLANNING_HISTORY_RETENTION_YEARS" | "DEPLOYMENT_BACKUP_TOKEN_HASH" | "ADMIN_PIN_HASH" | "BOOTSTRAP_TOKEN" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
