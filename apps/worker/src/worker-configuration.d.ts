/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings apps/worker/src/worker-configuration.d.ts` (hash: 46869bfd611fc148d34bae6001b2306b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATA_JURISDICTION" | "PUSH_RETENTION_DAYS" | "ADMIN_PIN_HASH">> {}
}
