/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings apps/worker/src/worker-configuration.d.ts` (hash: 669d0024de6be5bc69bb8eb7b5c05dd9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATA_JURISDICTION" | "PUSH_RETENTION_DAYS" | "ADMIN_PIN_HASH" | "BOOTSTRAP_TOKEN" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
