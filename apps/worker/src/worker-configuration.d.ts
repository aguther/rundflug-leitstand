/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../../wrangler.jsonc --env-interface=CloudflareBindings src/worker-configuration.d.ts` (hash: 469a85b149b2403614d9e3c1c4317ea7)
