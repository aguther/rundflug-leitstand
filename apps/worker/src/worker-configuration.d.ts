/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings apps/worker/src/worker-configuration.d.ts` (hash: d5520cebac2b948723341e54de6a50a6)
// Runtime types generated with workerd@1.20260730.1 2026-07-11 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATA_JURISDICTION" | "PUSH_RETENTION_DAYS" | "SOURCE_REVISION" | "ANALYSIS_RETENTION_DAYS" | "ADMIN_PIN_HASH" | "BOOTSTRAP_TOKEN" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
