/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings apps/worker/src/worker-configuration.d.ts` (hash: 469a85b149b2403614d9e3c1c4317ea7)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATA_JURISDICTION" | "PUSH_RETENTION_DAYS" | "SOURCE_REVISION" | "ANALYSIS_RETENTION_DAYS" | "PLANNING_DETAIL_RETENTION_HOURS" | "PLANNING_HISTORY_RETENTION_YEARS" | "ADMIN_PIN_HASH" | "BOOTSTRAP_TOKEN" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
