...
export function buildForecastHistoryStatement(
  ...
  return {
    ...
    sql: `SELECT fs.id AS snapshot_id, fs.rotation_id, r.flight_group_id,
                 ...
                 fs.product_id, fs.assumed_aircraft_id, fs.boarding_minutes,
                 fs.deboarding_minutes, fs.buffer_minutes, fs.boarding_source,
                 fs.deboarding_source, fs.buffer_source,
                 fs.dispatch_plan_id, fs.dispatch_plan_revision, fs.dispatch_batch_id,
                 fs.dispatch_order, fs.dispatch_wave, fs.dispatch_lane_id,
                 fs.dispatch_group_ids_json, fs.dispatch_occupied_seats,
                 fs.dispatch_available_seats, fs.dispatch_commitment_level,
                 fs.dispatch_decision_reasons_json, fs.dispatch_decision_details_json,
                 fs.dispatch_confirmed_overtake_count,
                 fs.dispatch_projected_overtake_count,
                 fs.dispatch_unplanned_reason,
