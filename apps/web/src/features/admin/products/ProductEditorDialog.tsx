      ...
      >
        ...
        <div className="parameter-grid">
          ...
          <div className="field-control">
            ...
            />
            <small>Quelle: {editor.boardingOverride === "" ? "Veranstaltung" : "Produkt"}</small>
            <button
          ...
          <div className="field-control">
            ...
            />
            <small>Quelle: {editor.deboardingOverride === "" ? "Veranstaltung" : "Produkt"}</small>
            <button
              className="table-action"
              onClick={() =>
          ...
          <ProductReferenceRotation
            ...
            bufferMinutes={
              editor.bufferOverride === "" ? plannedBufferMinutes : Number(editor.bufferOverride)
            }
            deboardingMinutes={
              editor.deboardingOverride === ""
