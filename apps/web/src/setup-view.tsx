    ...
    <AccessPageFrame
      description={
        status && !status.setupRequired
          ? undefined
          : "Legt die erste Veranstaltung und das erste anonyme Administrationskonto an. Es werden keine Personen- oder Gastnamen erfasst."
      }
      eyebrow="Einmaliger Systemstart"
      notifications
      title="Rundflug-Leitstand einrichten"
      titleId="setup-title"
      variant="form"
    >
      {status && !status.setupRequired ? (
        <>
          ...
          <a className="access-page-link" href="/admin">
            Zur Administration
          </a>
        </>
      ) : (
        <>
          ...
          <Button
            busy={busy}
            className="access-page-submit setup-submit"
            type="button"
