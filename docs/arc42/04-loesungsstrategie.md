...
| Konfigurierbarkeit ohne Deployment | Betriebsparameter, Texte, Schwellenwerte und Zeitmodelle sind Stammdaten und werden über dieselbe Kommandopipeline geändert | `docs/architecture/maintainability-and-extension-v1.md` |
