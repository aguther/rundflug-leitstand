...
| V191-PRN-010 | Der POS-58-Ausdruck enthält ausschließlich das Ticket, beginnt ohne Vorlauf, besitzt keine feste Rollenlänge, vergrößert QR-Code und Schrift innerhalb des 52-mm-Inhalts und zentriert den Inhalt links/rechts auf der 58-mm-Rollenachse. Direktdruck bleibt eine dokumentierte Betriebskonfiguration des Browsers und Standarddruckers, keine Umgehung des Browser-Sicherheitsmodells durch die PWA. | MUSS |
