...
| V172-AST-010 | Assist verwendet dieselben vier Abschlussaktionen ohne separate Folgezustandsauswahl, 56-Pixel-Aktionsziele ohne unnötige Trennlinie sowie getrennt umrandete Nachbarelemente für Pilotencode und Pilotwechsel. Im aktuellen Umlauf entfallen die redundanten Felder Status und Pilot. Die vergrößerte Beschriftung „Buchungsgruppen“ steht über den Gruppenwerten; für bis zu sechs Gruppen bleiben stabil höchstens zwei Wertzeilen reserviert. Ohne aktiven oder früheren Umlauf bleibt diese normale Ansicht mit leerer Buchungsgruppenfläche sichtbar; eine vorhandene Flugzeug-Verfügbarkeitszeit bleibt in der Zeitlinie erhalten. Die Ansicht bleibt bei 320×568 ohne Dokument-Scroll bedienbar. | MUSS |
