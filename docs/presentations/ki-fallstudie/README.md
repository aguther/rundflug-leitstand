...
- `render.cjs`: lokaler PDF-Renderer mit Bild-, Mermaid- und Folienzahl-Prüfung.
- `rundflug-leitstand-ki-fallstudie.pdf`: finale Ausgabe mit 26 Hauptfolien und 14 vertiefenden Anhangsfolien.
...
Die Hauptdramaturgie bleibt bewusst klar und präsentationsfähig. Interne Gestaltungsprinzipien werden nicht als eigene Folie gezeigt. Technische und methodische Vertiefungen stehen im Anhang.
