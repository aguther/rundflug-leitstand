...
- Rücknahme von `NEXT` innerhalb von zehn Sekunden als eigenes, auf den ursprünglichen Aufruf
  verweisendes Korrekturereignis; Umlauf und Flugzeug kehren in den Vorschlagszustand zurück,
- erneuter bestätigter Aufruf nach der Rücknahme,
...
abgelehnt, `NEXT` nachvollziehbar zurückgenommen und erneut bestätigt, alle vier Zustandsereignisse
bestätigt, zwei Tickets im selben Umlauf, alle Ist-Zeitpunkte vorhanden und finale Event-Version 9.
