...
| AZ_q8Zi7jAxtp6gqKeqM | High | Maintainability | typescript:S3776 | `apps/web/src/features/admin/master-data/useAdminMasterDataActions.ts:622` | Refactor this function to reduce its Cognitive Complexity from 16 to the 15 allowed. | FIX | Berechtigt: die Produktvalidierung kodierte die fachliche Feldreihenfolge als fünfstufige Ternary-Kaskade. Benannte Validierungsfunktionen machen das erste zu fokussierende Fehlerfeld explizit. | Niedrig; Command-Aufruf und Feldreihenfolge bleiben unverändert. | `useAdminMasterDataActions.test.tsx`: ungültiger Name vor weiteren Produktfeldern, kein Admin-Command; lokaler Sonar-Dateiscan ohne S3776. | Folgescan muss schließen |
| AZ_q8Zi7jAxtp6gqKeqR | High | Maintainability | typescript:S3776 | `apps/web/src/features/admin/master-data/useAdminMasterDataActions.ts:643` | Refactor this function to reduce its Cognitive Complexity from 18 to the 15 allowed. | FIX | Berechtigt: Kategorieauswahl und verschachtelte Resource-Group-/Aircraft-Validierung waren in einer Funktion gekoppelt. Die Feldvalidatoren besitzen nun je Entität eine lineare Priorität. | Niedrig; öffentliche Hook-API und Save-Dispatch bleiben unverändert. | `useAdminMasterDataActions.test.tsx`: Aircraft-Registrierung wird vor Typ fokussiert; insgesamt 11 Tests; lokaler Sonar-Dateiscan ohne S3776. | Folgescan muss schließen |
...
| AZ_qaAPCYdlOTNJd7e6i | High | Maintainability | typescript:S3776 | `apps/web/src/features/admin/operations/AdminOperationsPanel.tsx:30` | Refactor this function to reduce its Cognitive Complexity from 16 to the 15 allowed. | FIX | Berechtigt: Freigabestatus, Freigabeaktion und übrige Operationssteuerung lagen in einem Renderpfad. Das Event-Release-Panel ist nun eine fachlich geschlossene Komponente. | Niedrig; Props und ausgelöste Callbacks bleiben unverändert. | `AdminOperationsPanel.dom.test.tsx`: 5 DOM-Abläufe; lokaler Sonar-Dateiscan ohne Issues. | Folgescan muss schließen |
| AZ_qRD1vLqw2KI1-RGKq | High | Maintainability | typescript:S3776 | `apps/web/src/features/admin/overview/AdminAccessStatusBar.tsx:17` | Refactor this function to reduce its Cognitive Complexity from 24 to the 15 allowed. | FIX | Berechtigt: Authentisierung, Sitzungsfreigabe, Aktionen und Board-Ladehinweis waren durch wiederholte Ternaries gekoppelt. Präsentationsentscheidung und Board-Hinweis sind jetzt benannt. | Niedrig; gerenderte Texte, Aktionen und öffentliche Props bleiben unverändert. | `AdminAccessStatusBar.dom.test.tsx`: 3 Zustands-/Aktionsfälle; Typecheck, Lint und lokaler Sonar-Dateiscan ohne Issues. | Folgescan muss schließen |
...
| AZ_l6Ce1LlJq96xp0cad | High | Maintainability | typescript:S3776 | `apps/web/src/features/public-status/use-public-push.ts:123` | Refactor this function to reduce its Cognitive Complexity from 18 to the 15 allowed. | FIX | Berechtigt: Umgebungsprüfung, Subscription-Lifecycle und Serverregistrierung lagen in einem Hook-Effekt. Laden, Aktivieren, Deaktivieren und Server-Revoke sind nun getrennte Lifecycle-Verantwortungen. | Mittel; Browser-Permission, Push-Subscription und Serverzustand müssen konsistent bleiben. | `use-public-push.dom.test.tsx`: Restore/Revoke, Permission/Register, denied permission und Konfigurations-/Netzfehler; 6 Tests; lokaler Sonar-Dateiscan ohne Issues. | Folgescan muss schließen |
...
| AZ_l6Cq_LlJq96xp0cf5 | High | Maintainability | typescript:S3776 | `apps/web/src/flight-line-assist.tsx:66` | Refactor this function to reduce its Cognitive Complexity from 23 to the 15 allowed. | FIX | Berechtigt: Auswahlmodus, Claim-Konflikte und Arbeitsmodus waren in einer Komponente verschachtelt. Die Flugzeugauswahl und benannte Aktionsentscheidungen trennen Zustände ohne die exklusive Claim-Semantik zu verändern. | Mittel; Takeover-Revision, Lease-Freigabe und exklusive Betreuung sind betrieblich relevant. | `flight-line-assist.dom.test.tsx`: Claim/Arbeitsmodus, bewusste Übernahme, Paging/Refresh-Fehler und Release; 18 gezielte Tests; lokaler Sonar-Dateiscan ohne Issues. | Folgescan muss schließen |
...
| AZ_oPiVYMZUky4BdXok0 | High | Maintainability | typescript:S3776 | `apps/worker/src/admin-event-deletion-service.ts:66` | Refactor this function to reduce its Cognitive Complexity from 33 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: referenzielle Vorprüfung, Löschplan und Audit-/Outbox-Persistenz sind gekoppelt. Zielpaket: Entitätsabhängigkeiten in typisierte Löschpläne auslagern; atomare Batch-Grenze unverändert lassen. | Hoch; vollständige Ereignislöschung und Recovery dürfen nicht partiell werden. | `admin-event-deletion.test.ts`; Folgepaket benötigt zusätzliche Fehlerpfade. | Bleibt offen; separates Architekturpaket |
| AZ_n-KulycsaNSwwUGRO | High | Maintainability | typescript:S3776 | `apps/worker/src/admin-master-data-template-routes.ts:184` | Refactor this function to reduce its Cognitive Complexity from 31 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Import-Route mischt Transportvalidierung, Referenzauflösung und Persistenz. Zielpaket: validiertes Importmodell und Persistenzplan trennen. | Mittel; Template-Kompatibilität und vollständige Validierung müssen erhalten bleiben. | `admin-master-data-template.test.ts`; 79 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_ok5wVA1Estd7HihpD | High | Maintainability | typescript:S3776 | `apps/worker/src/analysis-control-routes.ts:59` | Refactor this function to reduce its Cognitive Complexity from 36 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Snapshot-Erzeugung koordiniert mehrere konsistente Versionslesungen. Zielpaket: Versions-Gate, Board-Aufbau und Exportabbildung als explizite Phasen. | Hoch; ein inkonsistenter Snapshot wäre betrieblich irreführend. | `analysis-control-routes.test.ts`; 90 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_ok5wVA1Estd7HihpI | High | Maintainability | typescript:S3776 | `apps/worker/src/analysis-control-routes.ts:281` | Refactor this function to reduce its Cognitive Complexity from 16 to the 15 allowed. | ACCEPTED | Formal knapp über Grenzwert (16): Route bildet bewusst die externen Archivfehler in HTTP-Status ab; lokale Extraktion würde die Fehlerzuordnung zerstreuen, ohne die Entscheidung zu vereinfachen. Neubewertung bei zusätzlichem Archivstatus. | Niedrig bei Beibehaltung; Refactoring würde Diagnosepfade verteilen. | `analysis-control-routes.test.ts`; 90 % Lines. | Kommentar + Status offen |
| AZ_mPxisZ8Hac6hzcA1u | High | Maintainability | typescript:S3776 | `apps/worker/src/analysis-snapshot-capture-service.ts:61` | Refactor this function to reduce its Cognitive Complexity from 24 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Snapshot-Capture koordiniert Recalculation, Versionsprüfung und Persistenz. Zielpaket: Capture-Phasen mit typisierten Ergebnissen modellieren. | Hoch; Snapshot und Eventversion müssen konsistent bleiben. | `analysis-snapshot-capture-service.test.ts`; 71 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_l6CawLlJq96xp0cYY | High | Maintainability | typescript:S3776 | `apps/worker/src/analysis-snapshot.ts:176` | Refactor this function to reduce its Cognitive Complexity from 22 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Exportaufbau mischt Lineage-Lesen, Datenbereinigung und Schemaabbildung. Zielpaket: Loader, Validierer und DTO-Assembler trennen. | Mittel; Analysepakete müssen replay-kompatibel bleiben. | `forecast-snapshot-coverage.test.ts` und Replay-Tests; aktuell 18 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_nW6vjXLQn_jWP8KX_ | High | Maintainability | typescript:S3776 | `apps/worker/src/auth-routes.ts:52` | Refactor this function to reduce its Cognitive Complexity from 18 to the 15 allowed. | ACCEPTED | Formal berechtigt (18), aber Login folgt einer sicherheitskritischen linearen Reihenfolge aus Rate-Limit, Konto-/PIN-Prüfung, Sessionanlage und Audit. Weitere Aufteilung würde Kontrollfluss und Early Returns schlechter nachvollziehbar machen. Neubewertung bei neuem Auth-Schritt. | Mittel; Reihenfolge ist sicherheitsrelevant. | `auth-routes.test.ts`; 100 % Lines, 80,6 % Branches. | Kommentar + Status offen |
| AZ_l6CYWLlJq96xp0cXX | High | Maintainability | typescript:S3776 | `apps/worker/src/dispatch-recommendation-lease-service.ts:273` | Refactor this function to reduce its Cognitive Complexity from 47 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Handler vereint Autorisierung, Idempotenz, Lease-Relevanz, Forecast-Auswahl und atomare Persistenz. Zielpaket: Request-Gate, Lease-Entscheidung und Persistenzplan trennen. | Hoch; exklusive Lease-, Idempotenz- und Forecast-Invarianten. | `dispatch-recommendation-leases.test.ts`: 67,25 % Lines / 57,01 % Branches für Service. | Bleibt offen; separates Architekturpaket |
| AZ_l6CaGLlJq96xp0cX0 | High | Maintainability | typescript:S3776 | `apps/worker/src/event-coordinator.ts:520` | Refactor this function to reduce its Cognitive Complexity from 36 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Coordinator mischt Authentisierung, Idempotenz, Preflight, Rollenprüfung und Dispatch. Zielpaket: authentisierten Command-Kontext und Preflight-Ergebnis als eigene Phasen. Die fachlich eigenständigen Versions-, Aggregat- und Planeintragsprüfungen wurden vorab als reine Preflight-Policy isoliert; dies löst den komplexen Auth-/Dispatch-Ablauf bewusst noch nicht. | Sehr hoch; zentrale Autorisierung, stale-write- und Idempotenzgrenze. | Registry-, Preflight- und V1-Integrationstests sowie 15 Policy-Tests für Eventversion, Aggregatversion und Planeintragsstatus; extrahierte Policy 100 % in allen lokalen Metriken. | Bleibt offen; separates Architekturpaket |
| AZ_nykgrXLQn_jWP_PRR | High | Maintainability | typescript:S3776 | `apps/worker/src/factory-reset-routes.ts:55` | Refactor this function to reduce its Cognitive Complexity from 23 to the 15 allowed. | ACCEPTED | Formal berechtigt, aber der destruktive Reset ist absichtlich ein linear sichtbarer Ablauf aus Autorisierung, Bestätigung, Löschung und Grant-Neuanlage. Aufteilung würde die Vollständigkeitsprüfung erschweren. Neubewertung bei zusätzlicher Ressource. | Hoch; fehlende Ressource würde Restdaten hinterlassen. | `factory-reset-routes.test.ts`; 98,5 % Lines / 92,1 % Branches. | Kommentar + Status offen |
| AZ_l6CYiLlJq96xp0cXZ | High | Maintainability | typescript:S3776 | `apps/worker/src/fleet-administration-command-service.ts:24` | Refactor this function to reduce its Cognitive Complexity from 106 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Flottenkommando behandelt mehrere fachlich verschiedene Mutationen in einer Funktion. Zielpaket: Pilot-, Flugzeug- und Membership-Pläne trennen. | Hoch; aktive Zuordnung und laufende Umläufe sind Invarianten. | `fleet-administration-command-service.test.ts`; 59 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_0vUisxILwZHPZZnut | High | Maintainability | typescript:S3776 | `apps/worker/src/forecast-timeline-projector.ts:25` | Refactor this function to reduce its Cognitive Complexity from 19 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Projector transformiert zahlreiche persistierte Teilmodelle und paart Flugzeug-/Pilotfenster. Zielpaket: Verfügbarkeitsfenster, Pairing und Dispatch-Replay in reine Projektoren trennen. | Mittel; Forecast-Semantik und deterministische Reihenfolge dürfen nicht abweichen. | Forecast-Pipeline-Tests; 96,2 % Lines / 66,8 % Branches. | Bleibt offen; separates Architekturpaket |
| AZ_l6CYHLlJq96xp0cXN | High | Maintainability | typescript:S3776 | `apps/worker/src/master-data-command-service.ts:24` | Refactor this function to reduce its Cognitive Complexity from 27 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Gate- und Produkt-Upsert teilen einen Handler mit unterschiedlichen Referenzprüfungen. Zielpaket: typisierte Upsert-Pläne je Entität. | Mittel; bestehende API und atomare Auditierung bleiben. | `master-data-command-service.test.ts`; Service 40,1 % Lines nach Extraktion. | Bleibt offen; separates Architekturpaket |
...
| AZ_l6CYHLlJq96xp0cXQ | High | Maintainability | typescript:S3776 | `apps/worker/src/master-data-command-service.ts:891` | Refactor this function to reduce its Cognitive Complexity from 68 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Ressourcengruppe, Flugzeug und Membership besitzen unterschiedliche Invarianten in einem Handler. Zielpaket: drei validierte Mutationspläne mit gemeinsamer Commit-Grenze. | Hoch; exklusive aktive Flugzeugzuordnung und aktive Umläufe. | `master-data-command-service.test.ts`; Reassignment-Konflikt abgedeckt. | Bleibt offen; separates Architekturpaket |
| AZ_pID3-TmPyO1xhSKnR | High | Maintainability | typescript:S3776 | `apps/worker/src/operations-routes.ts:585` | Refactor this function to reduce its Cognitive Complexity from 25 to the 15 allowed. | ACCEPTED | Formal berechtigt (25), aber die Route bildet ein flaches Read-Model mit optionalen Filtern und stabiler Response-Struktur; Extraktion würde nur Feldmapping verteilen. Neubewertung bei neuer fachlicher Entscheidung. | Niedrig; Read-only-Route. | `operations-routes.test.ts`; 95,4 % Lines. | Kommentar + Status offen |
| AZ_mOVkfIdg5QZyC966P | High | Maintainability | typescript:S3776 | `apps/worker/src/outage-recovery-command-service.ts:35` | Refactor this function to reduce its Cognitive Complexity from 87 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Recovery vereint Konfliktsimulation, Vier-Augen-Freigabe und heterogene Replay-Persistenz. Zielpaket: Entry-Validatoren und typspezifische Apply-Pläne. | Sehr hoch; Datenverlust/Doppelbuchung bei falscher Zerlegung. | `outage-recovery-command-service.test.ts`; 56,7 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_l6CamLlJq96xp0cYJ | High | Maintainability | typescript:S3776 | `apps/worker/src/planned-operation-command-service.ts:25` | Refactor this function to reduce its Cognitive Complexity from 89 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: geplante Operationen bündeln Scope-Validierung, Überlappung und Persistenz. Zielpaket: Validator und Persistenzplan pro Command. | Hoch; Blockierungswirkung und Zeitfenster. | `planned-operation-command-service.test.ts`; 51 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_nDclgaa4LEs-MCg0B | High | Maintainability | typescript:S3776 | `apps/worker/src/public-status-routes.ts:130` | Refactor this function to reduce its Cognitive Complexity from 19 to the 15 allowed. | ACCEPTED | Formal berechtigt (19): öffentliche Ticketstatus-Route ist ein linearer Read-/Mapping-Pfad; die Verzweigungen spiegeln explizit Not-found, Freshness und öffentliche Projektion. Neubewertung bei weiterer Statusfamilie. | Mittel; öffentliche Datenminimierung muss sichtbar bleiben. | `public-status-routes.test.ts`; 93,9 % Lines / 87,5 % Branches. | Kommentar + Status offen |
| AZ_l6CacLlJq96xp0cYF | High | Maintainability | typescript:S3776 | `apps/worker/src/recurring-operational-rule-command-service.ts:20` | Refactor this function to reduce its Cognitive Complexity from 43 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: wiederkehrende Regeln bündeln Scope-, Intervall- und Lifecycle-Validierung. Zielpaket: Regeldefinition und Zustandsmutation trennen. | Mittel; Forecast-Auswirkung darf nicht verändert werden. | `recurring-operational-rule-command-service.test.ts`; 86,3 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_mYLISMZUky4BdP8BY | High | Maintainability | typescript:S3776 | `apps/worker/src/rotation-transition-command-service.ts:59` | Refactor this function to reduce its Cognitive Complexity from 102 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: ein großer Zustandsautomat behandelt mehrere Rotationstransitionen samt Audit/Outbox. Zielpaket: Transition-Plan je Command, gemeinsame atomare Commit-Funktion. | Sehr hoch; operative Zustände, Ticketbindung und Flugzeugverfügbarkeit. | `rotation-transition-command-service.test.ts`; 34,2 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_l6CYtLlJq96xp0cXc | High | Maintainability | typescript:S3776 | `apps/worker/src/ticket-group-mutation-command-service.ts:36` | Refactor this function to reduce its Cognitive Complexity from 32 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Gruppenmutation vereint Split-/Merge-/Release-Regeln und Persistenz. Zielpaket: gruppenschutzwahrende Mutationspläne. | Sehr hoch; Gruppen dürfen nicht automatisch getrennt werden. | `ticket-group-mutation-command-service.test.ts`; 77 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_yzGffrVS8B668Tqoy | High | Maintainability | typescript:S3776 | `apps/worker/src/ticket-sales-command-service.ts:26` | Refactor this function to reduce its Cognitive Complexity from 21 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Verkauf bündelt Produktprüfung, Kapazität, Splitplan, Codeallokation und atomare Persistenz. Zielpaket: validierte Sale-Entscheidung und Persistenzplan. | Sehr hoch; Doppelcodes, Zahlungen und Gruppenschutz. | `ticket-sales-command-service.test.ts`; 77 % Lines. | Bleibt offen; separates Architekturpaket |
| AZ_0vVwyxILwZHPZZnuw | High | Maintainability | typescript:S3776 | `packages/domain/src/forecast-projection.ts:202` | Refactor this function to reduce its Cognitive Complexity from 35 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Legacy-Forecast berechnet Historienbasis, Unsicherheit, Kapazität und Zeitfenster in einem Mapping. Zielpaket: Profil-/Historienwahl und Unsicherheitsbewertung extrahieren. | Hoch; fachliche Forecast-Semantik. | Domain-Forecasttests; Datei 96,9 % Lines / 91,7 % Branches. | Bleibt offen; separates Architekturpaket |
| AZ_0vVwyxILwZHPZZnuy | High | Maintainability | typescript:S3776 | `packages/domain/src/forecast-projection.ts:501` | Refactor this function to reduce its Cognitive Complexity from 55 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Dispatch-Forecast verbindet Lane-Verfügbarkeit, Planer, Replay und Projektion. Zielpaket: Availability Builder, Replay und Projection Mapper. | Hoch; deterministische Planung und Gruppenschutz. | Domain-Forecast-/Dispatch-Tests; Datei 96,9 % Lines / 91,7 % Branches. | Bleibt offen; separates Architekturpaket |
| AZ_0vVwyxILwZHPZZnu0 | High | Maintainability | typescript:S3776 | `packages/domain/src/forecast-projection.ts:940` | Refactor this function to reduce its Cognitive Complexity from 23 to the 15 allowed. | ARCHITECTURE_BACKLOG | Berechtigt: Ergebnisprojektion kombiniert nicht geplante Gründe, Kapazitätsstatus und Dispatch-Metadaten. Zielpaket: reinen Projection Mapper extrahieren. | Mittel; öffentliche/operative Forecast-Zustände müssen stabil bleiben. | Domain-Forecasttests; Datei 96,9 % Lines / 91,7 % Branches. | Bleibt offen; separates Architekturpaket |
...
| AZ_l6CdYLlJq96xp0cZh | S6847 · `ForecastTimeline.tsx:281` | FALSE_POSITIVE | Der überlaufende Zeitachsenbereich ist absichtlich per Tastatur scrollbar; Handler implementiert PageUp/PageDown/Home/End. | `ForecastTimeline.dom.test.tsx` + Handlerprüfung | Kommentiert; `FALSE_POSITIVE` per MCP verifiziert |
| AZ_l6CdYLlJq96xp0cZi | S6845 · `ForecastTimeline.tsx:286` | FALSE_POSITIVE | `tabIndex=0` ist für die Tastaturbedienung des Scrollbereichs erforderlich; Entfernen wäre eine Accessibility-Regression. | `ForecastTimeline.dom.test.tsx` | Kommentiert; `FALSE_POSITIVE` per MCP verifiziert |
