...
Version 1.10.0 · Ziel: Ereignisse am übernommenen Flugzeug zeitnah und eindeutig melden.
...
2. Aktuelle Buchungsgruppen und den hervorgehobenen nächsten zulässigen Schritt lesen.
...
![Aktuelle Flight-Line-Ansicht mit synthetischen Daten](images/flight-line-1.10.0.png)
