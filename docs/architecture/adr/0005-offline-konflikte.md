...
- Status: Teilweise ersetzt durch ADR-0051
- Datum: 2026-07-11
...
ADR-0051 ersetzt die ursprüngliche Übertragung einer allgemeinen Offline-Kommando-Queue. Gültig
bleiben der letzte bestätigte Snapshot, Idempotenz, Expected-Version und die sichtbare
Konfliktauflösung.
