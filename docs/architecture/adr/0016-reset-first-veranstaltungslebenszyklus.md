...
- Status: Teilweise ersetzt durch ADR-0052; ersetzt weiterhin Displaykopplungsanteile aus ADR-0013
- Datum: 2026-07-18
...
ADR-0052 ersetzt die Aussage, dass Archivierung im aktuellen V1-Stand nicht benötigt wird. Explizite
Veranstaltungslöschung, Rückkehr zur Ersteinrichtung und reset-first für freigegebene destruktive
Vorgänge bleiben gültig.
