...
- Status: Teilweise ersetzt durch ADR-0018, ADR-0019, ADR-0047 und ADR-0048
- Datum: 2026-07-17
...
- Die am 17. Juli 2026 bestätigten Referenzbilder in
  `docs/ui/v1.11.0-release-concept.md` und die aktuellen Rollenbilder sind die visuelle Quelle für
...
Die Designsystem- und Modulgrenzen bleiben gültig. Rollenbezeichnungen, Routenaufteilung,
Meldungsflächen, PWA-Updateverhalten, aktuelle Referenzbilder und Assetgrenzen folgen den genannten
Nachfolgeentscheidungen und dem freigegebenen V1.12-UI-Konzept.
