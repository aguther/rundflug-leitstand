...
| Unzureichende Aussagekraft einzelner Tests | präzisiert als [Mutationstest-Schuld](mutation-test-effectiveness.md); pauschale Rohtext- und `toContain`-Zahlen sind kein belastbares Qualitätsmaß mehr |
...
| Produktions-Quelltexttests über `?raw` | behoben; verbleibende Rohtextimporte prüfen bewusst Konfiguration, Dokumentation, Skripte und statische Artefakte, nicht TypeScript-/TSX-Produktionsimplementierungen |
