...
| QS-21 | Eine Rollenansicht erhält neue Logik oder Styles | Lazy Route-Grenzen bleiben erhalten; globale CSS, Flight-Line-CSS, größter JavaScript-Chunk, PWA-Precache und der vollständige statische Route-Importgraph überschreiten ihre ratcheted Budgets nicht | `npm run web:assets:verify`, `scripts/data/web-asset-baseline-5e1dce.json`, ADR-0048 |
