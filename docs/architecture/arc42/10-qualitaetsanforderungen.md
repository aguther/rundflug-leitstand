...
| QS-22 | Cloudflare-Runtime oder Compatibility-Date driften; ein D1-Baseline-Neuaufbau wird vorbereitet | Der normale CI-Check prüft Toolchain, Bindings und Observability; ein bewusst gestarteter Maintenance-Lauf kann zusätzlich das 45-Tage-Limit erzwingen. Das D1-CLI bleibt ohne zielgebundene Bestätigung read-only | `npm run cloudflare:maintenance`, `npm run cloudflare:recreate-d1`, ADR-0049, ADR-0058 |
