...
- **Dokumentation:** ADRs unter `docs/architecture/adr/`, Betriebsanleitungen unter
  `docs/operations/`, Verifikationsnachweise unter `docs/verification/`, diese Architekturübersicht
  unter `docs/architecture/arc42/`.
