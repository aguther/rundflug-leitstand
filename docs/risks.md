...
| R-07 | Push-Abonnements werden ohne wirksame Einwilligung verarbeitet oder nicht fristgerecht gelöscht. | M | hoch | F-BEN-020, D-110, Q-DSG-020, Q-DSG-030 | Consent-Ledger, minimale Daten, konfigurierbare Löschjobs, Ausschluss aus portablen Backups, Retry/Fehlerbericht | Consent-, Widerrufs- und zeitgesteuerte Löschtests | BP-07, BP-10 |
