...
RELEASE_1_11_REQUIREMENTS = [
    ...
    },
    {
        ...
        "module": "apps/worker/src/event-coordinator.ts sowie ADR-0038",
    ...
    },
    {
        ...
        "module": "packages/contracts/src/index.ts packages/domain/src/index.ts apps/worker/src/event-coordinator.ts sowie ADR-0038",
    ...
    },
    {
        ...
        "module": "apps/worker/src/index.ts apps/web/src/features/public-status/PublicStatusContent.tsx sowie ADR-0038",
        "tests": "apps/worker/src/ticket-group-recall.test.ts und npm run test:ticket-group-recall",
    },
    {
        "id": "V1110-FID-010",
        ...
        "module": "apps/web/src/fids-display.tsx apps/web/src/features/fids/fids-v12.css sowie ADR-0038",
    ...
    },
    {
        ...
        "module": "apps/web/src/flight-line-view.tsx apps/web/src/flight-line-shared.tsx sowie ADR-0038",
    ...
    },
    {
        ...
        "module": "scripts/verify_ticket_group_recall.mjs apps/worker/src/ticket-group-recall.test.ts sowie ADR-0038",
